import ProductsChart from "@/app/_components/products-chart";
...
export const metadata: Metadata = {
  title: "Dashboard",
  description:
    "Overview of your inventory, stock levels, and key business metrics.",
};
...
export default async function DashboardPage() {
  ...
  const test = await prisma.product.count({ where: { userId } });
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center mt-1">
                  ...
                  <s className="w-3 h-3 text-green-600 ml-1" />
                </div>
              </div>
